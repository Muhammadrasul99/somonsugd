...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if text == "Сурогаи склад роҳ 🚚":
        ...
        return
    elif text == "Борҳои қабулшуда дар Хуҷанд 🔍":
...
async def check_track_code(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not result.empty:
        ...
        if status_khujand:
            ...
            response = f"📦 Бори Шумо бо трек-коди {track_code} ба склади Хитой санаи {arrival_date} кабул шудааст ва дар муддати 15-25 руз ба Хучанд омада мерасад."
    else:
